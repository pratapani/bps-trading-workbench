    ...
    with open(
        ...
        for rank, result in enumerate(
            ...
            writer.writerow({
                ...
                # Actual executable market prices from Breeze.
                # SELL PE is executed at BID.
                # BUY PE is executed at OFFER.
                "SELL_PE_BID": result.get(
                    "sell_bid",
                    "",
                ),
                "SELL_PE_OFFER": result.get(
                    "sell_offer",
                    "",
                ),
                "BUY_PE_BID": result.get(
                    "buy_bid",
                    "",
                ),
                "BUY_PE_OFFER": result.get(
                    "buy_offer",
                    "",
                ),
